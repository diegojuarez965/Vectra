export default function FeatureCard({
  ...
  return (
    <div className="flex flex-col items-center md:items-start p-8 rounded-2xl bg-[#4a4a4a] hover:bg-[#505050] border border-foreground/5 transition-colors group">
      ...
      <p className="text-center md:text-left text-foreground/80 leading-relaxed">
        {description}
      </p>
    </div>
  );
