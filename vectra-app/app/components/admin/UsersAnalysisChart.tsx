"use client";
import { Users, AlertTriangle, Calendar, Dumbbell } from "lucide-react";
import {
  AreaChart,
  Area,
  XAxis,
...
// Interface de gráfica de usuarios analizando
interface UsersAnalysisChartProps {
