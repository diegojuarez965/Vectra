  ...
  if (success) {
    return (
      <div className="text-center space-y-6 animate-in fade-in zoom-in duration-300">
        ...
        <Link
          href="/login"
          className="w-full flex justify-center py-3 px-4 rounded-lg shadow-lg bg-white/10 hover:bg-white/20 text-foreground font-medium transition-all border border-white/5"
        >
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex justify-center mt-4">
        <Link
          href="/login"
          className="flex items-center gap-2 text-sm font-medium text-white/50 hover:text-foreground transition-colors"
        >
